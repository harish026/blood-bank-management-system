  ...
  return $fdata;
	...
	if($er==0)
	{
		...
		if( $auth==1)
		{
			...
			{
				$valid=0;
				echo"<script>alert('Invalid Password! password Must contain  atleast one number and  one uppercase and lowercase letter  and at least 5 or more characters')</script>";
			}
			if($valid==1)
			{
