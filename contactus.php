...
$er=0;
	if (empty($_POST["contactname"]))
		...
		if (!preg_match("/[a-zA-Z].{3,}$/",$contactname)) {
			$er=1;
...
<li class="inline"><a class="links" href="whybecomeadonor.html">Why Become Donor</a></li>
...
<br><br>
<div class="contacthead">Contact Us</div><span style="font-size:30px;"><b>Send us a message</b></span><br>
